...
struct Interface : Emulator::Interface {
  ...
  auto power(uint hCounter, uint vCounter, uint dramRefreshPosition) -> void override;
  auto reset(uint hCounter, uint vCounter, uint dramRefreshPosition) -> void override;
