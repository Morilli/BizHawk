...
$(info LDFLAGS_RELEASE: $(LDFLAGS_RELEASE))
$(info CCFLAGS: $(CCFLAGS))
$(info CCFLAGS_RELEASE: $(CCFLAGS_RELEASE))

$(TARGET_RELEASE): $(OBJS) $(EMULIBC_OBJS) $(LINKSCRIPT)
	@echo ld $@
	$(CC) -o $@ -v -Wl,--verbose $(LDFLAGS) $(LDFLAGS_RELEASE) $(CCFLAGS) $(CCFLAGS_RELEASE) $(OBJS) $(EMULIBC_OBJS) $(EXTRA_LIBS)
